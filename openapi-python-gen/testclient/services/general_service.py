...
def get_users_users_get() -> List[User]:
    base_path = APIConfig.base_path
    path = f"/users"
    headers = {
        "Content-Type": "application/json",
...
def get_user_users__user_id__get(
    user_id: int,
) -> User:
    base_path = APIConfig.base_path
...
def delete_user_users__user_id__delete(
    user_id: int,
) -> None:
    base_path = APIConfig.base_path
    path = f"/users/{user_id}"
...
def update_user_users__user_id__patch(
    user_id: int,
    data: User,
) -> User:
    base_path = APIConfig.base_path
...
def get_teams_teams_get() -> List[Team]:
    base_path = APIConfig.base_path
    path = f"/teams"
    headers = {
        "Content-Type": "application/json",
...
def get_team_teams__team_id__get(
    team_id: int,
) -> Team:
    base_path = APIConfig.base_path
...
def delete_team_teams__team_id__delete(
    team_id: int,
) -> None:
    base_path = APIConfig.base_path
    path = f"/teams/{team_id}"
...
def update_team_teams__team_id__patch(
    team_id: int,
    data: Team,
) -> Team:
    base_path = APIConfig.base_path
